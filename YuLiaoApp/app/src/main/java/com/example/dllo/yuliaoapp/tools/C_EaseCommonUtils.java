 ...
 */
public class C_EaseCommonUtils {
    ...
    public static EMMessage createExpressionMessage(String toChatUsername, String expressioName, String identityCode) {
        ...
        if (identityCode != null) {
            message.setAttribute(C_Constant.MESSAGE_ATTR_EXPRESSION_ID, identityCode);
        }
        message.setAttribute(C_Constant.MESSAGE_ATTR_IS_BIG_EXPRESSION, true);
        return message;
    }
    ...
    public static String getMessageDigest(EMMessage message, Context context) {
        ...
        switch (message.getType()) {
            ...
            case TXT: // 文本消息
                ...
                if (message.getBooleanAttribute(C_Constant.MESSAGE_ATTR_IS_VOICE_CALL, false)) {
                    digest = getString(context, R.string.voice_call) + txtBody.getMessage();
                } else if (message.getBooleanAttribute(C_Constant.MESSAGE_ATTR_IS_VIDEO_CALL, false)) {
                    digest = getString(context, R.string.video_call) + txtBody.getMessage();
                } else if (message.getBooleanAttribute(C_Constant.MESSAGE_ATTR_IS_BIG_EXPRESSION, false)) {
    ...
    public static EMConversation.EMConversationType getConversationType(int chatType) {
        if (chatType == C_Constant.CHATTYPE_SINGLE) {
            return EMConversation.EMConversationType.Chat;
        } else if (chatType == C_Constant.CHATTYPE_GROUP) {
