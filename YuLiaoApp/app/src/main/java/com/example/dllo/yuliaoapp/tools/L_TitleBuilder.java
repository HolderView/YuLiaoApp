...
public class L_TitleBuilder {
     ...
     * @param context
     */
    public L_TitleBuilder(Activity context) {
     ...
     * @param context
     */
    public L_TitleBuilder(View context) {
    ...
    public L_TitleBuilder setMiddleTitleBgRes(int resid) {
     ...
     * @return
     */
    public L_TitleBuilder setMiddleTitleText(String text) {
     ...
     * @return
     */
    public L_TitleBuilder setLeftImageRes(int resId) {
     ...
     * @return
     */
    public L_TitleBuilder setLeftText(String text) {
     ...
     * 设置左边的事件
     */
    public L_TitleBuilder setLeftTextOrImageListener(View.OnClickListener listener) {
     ...
     * @return
     */
    public L_TitleBuilder setRightImageRes(int resId) {
     ...
     * @return
     */
    public L_TitleBuilder setRightText(String text) {
     ...
     * 设置左边的事件
     */
    public L_TitleBuilder setRightTextOrImageListener(View.OnClickListener listener) {
